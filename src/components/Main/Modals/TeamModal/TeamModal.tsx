            ...
            <div className="modal-card">
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-title" id="team-modal-title">
                        ...
                        <button className="button edit_team-name" slot="teamModal_edit_button" id="teamModal-edit-button">Éditer le nom</button>
                        <button className="delete close" type="button" slot="teamModal_closeButton"></button> 
                    </div>
                    ...
                    <div className="teamModal-pokemon">
                        ...
                        <div className="teamModal-pokemon-figures" id="teamModal-pokemon-figures" slot="teamModal-pokemon-figures">
