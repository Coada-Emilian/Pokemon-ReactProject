...
export default function PokemonArticle({pokemon} : PokemonProps) {
    ...
    return(
        ...
        <article className="pokemon-article">
            ...
            <a href="#" className="pokemon-card-anchor" onClick={
                () => {
                    setIsModalOn(true)
                }
            }>
                ...
                <div className="card selectable" slot="pokemonArticle_id">
                    ...
                    <div className="pokemon-card" slot="pokemonArticle_card">
                        ...
                        <footer className="card-footer">
                            <button className="add-button button is-light" slot="pokemonArticle_addButton">Ajouter à l'équipe</button>
                            <button className="remove-button button is-dark" slot="pokemonArticle_removeButton">Retirer de l'équipe</button>
                        </footer>
